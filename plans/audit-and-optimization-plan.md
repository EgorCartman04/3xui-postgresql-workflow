...
- **Суть:** Строки 15 и 88 содержат `2.26.101.31` — устаревший/неверный IP. Корректный
  IP во всём проекте: `2.27.23.76` (inventories, README, tunnel.sh, CI). Ручное
  обновление 3x-ui ломается.
- **Правка:** Заменить `2.26.101.31` → `2.27.23.76` в строках 15 и 88.
...
- **Правки:**
  ...
  - Заменить `ssh-keyscan -H 2.27.23.76` на использование предзаписанного known_hosts
